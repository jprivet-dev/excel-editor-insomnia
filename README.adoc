...
Study of a {git_url_spa}[SPA (Angular)] and an {git_url_api}[API (Symfony)], with Excel files management (upload, consultation/modification of data, rights of the authenticated user).
